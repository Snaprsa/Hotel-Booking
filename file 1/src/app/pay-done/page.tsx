    ...
    return (
      <div className="w-full flex flex-col sm:rounded-2xl space-y-10 px-0 sm:p-6 xl:p-8">
        ...
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-400 px-4 py-3 rounded-lg">
          Your reservation has been successfully created. No payment is required at this time.
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center">
            ...
            <div className="pt-5  sm:pb-5 sm:px-5 space-y-3">
              ...
              <span className="block  text-sm text-neutral-500 dark:text-neutral-400">
                {booking.property.bedrooms} beds · {booking.property.bathrooms} baths
              </span>
              <div className="w-10 border-b border-neutral-200  dark:border-neutral-700"></div>
              <StartRating point={booking.property.reviewStart} reviewCount={booking.property.reviewCount} />
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex justify-between text-neutral-6000 dark:text-neutral-300">
              ...
              <span className="flex-1 font-medium text-green-600 dark:text-green-400">
                {booking.status.charAt(0).toUpperCase() + booking.status.slice(1)}
              </span>
            </div>
            {booking.specialRequests && (
              <div className="flex flex-col text-neutral-6000 dark:text-neutral-300">
                <span className="mb-2">Special requests</span>
        ...
        <div className="space-y-4">
          <p className="text-sm text-neutral-500 dark:text-neutral-400">
            A confirmation email has been sent to {booking.guestEmail}. Please keep your booking code for reference.
          </p>
          <div className="flex gap-4">
            <ButtonPrimary href="/">Explore more stays</ButtonPrimary>
            <ButtonPrimary href={`/account-bookings?email=${booking.guestEmail}`}>
              View my bookings
            </ButtonPrimary>
          </div>
        </div>
